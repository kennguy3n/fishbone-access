/**
 * Circular progress ring used for dashboard "security health" and other
 * at-a-glance score surfaces. The arc length encodes `value` (0–100) and the
 * colour follows the same thresholds used elsewhere: green > 80, amber > 50,
 * red ≤ 50. Null/undefined values render as an empty ring with an em-dash so
 * a loading or unavailable state never reads as a false zero.
 */
