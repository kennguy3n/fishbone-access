  ...
  return (
    <LocaleContext.Provider value={value}>
      <IntlProvider
        ...
        onError={(err) => {
          // Feature screens render via <FormattedMessage defaultMessage=…>
          // and are localized incrementally, so a key that isn't yet in the
          // active locale's catalog is expected — react-intl already falls
          // back to the inline English default. Swallow that specific noise
          // (and the related missing-data warning) but let real formatting
          // errors surface.
          if (
