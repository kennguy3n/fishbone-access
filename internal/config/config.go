...
func (c Config) String() string {
	return fmt.Sprintf(
		"Config{env=%s http=%s db=%t driver=%s redis=%t dek=%t kms=%t kmsver=%d ratelimit=%t/%grps/%dburst/shared=%t usagemetering=%t/%s/shared=%t hibernation=%t/idle=%s workermetrics=%q iamcore=%t issuer=%q}",
