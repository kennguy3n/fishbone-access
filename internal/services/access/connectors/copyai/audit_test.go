...
func TestCopyAIFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestCopyAIFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestCopyAIFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
