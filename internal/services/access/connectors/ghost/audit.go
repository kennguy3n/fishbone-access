...
// FetchAccessAuditLogs implements access.AccessAuditor for Ghost.
//
// Ghost does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *GhostAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*GhostAccessConnector)(nil)
