...
func smValidConfig() map[string]interface{} { return map[string]interface{}{} }
func smValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "sm-token-AAAA"}
}

func TestSurveyMonkeyConnectorFlow_FullLifecycle(t *testing.T) {
...
func TestSurveyMonkeyConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
