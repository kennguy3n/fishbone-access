...
func validSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "sm_AAAA1234bbbbCCCC"}
}
...
func TestSync_PaginatesUsers(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if calls == 1 {
			...
			body["data"] = []map[string]interface{}{{"id": "1", "username": "alice", "email": "a@x.com", "first_name": "A", "last_name": "L"}}
			body["links"] = map[string]interface{}{"next": "https://api.surveymonkey.com/v3/users?page=2"}
		} else {
			if page != "2" {
				t.Errorf("page = %q", page)
			}
			body["data"] = []map[string]interface{}{{"id": "2", "username": "bob", "email": "b@x.com", "first_name": "B", "last_name": "B"}}
