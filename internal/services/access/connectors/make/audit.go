...
// FetchAccessAuditLogs implements access.AccessAuditor for Make.
//
// Make does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *MakeAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*MakeAccessConnector)(nil)
