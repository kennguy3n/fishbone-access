...
func udemyValidConfig() map[string]interface{} {
	return map[string]interface{}{"org": "acme"}
}
func udemyValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "udemy_demo_token"}
}

func TestUdemyBusinessConnectorFlow_FullLifecycle(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		usersPath := "/organizations/acme/users"
	...
	cfg := udemyValidConfig()
	secrets := udemyValidSecrets()
...
func TestUdemyBusinessConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		udemyValidConfig(), udemyValidSecrets(),
