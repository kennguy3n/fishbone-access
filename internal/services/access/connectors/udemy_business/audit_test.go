...
func TestUdemyBusinessFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestUdemyBusinessFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestUdemyBusinessFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
