...
// FetchAccessAuditLogs implements access.AccessAuditor for Wix.
//
// Wix does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *WixAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*WixAccessConnector)(nil)
