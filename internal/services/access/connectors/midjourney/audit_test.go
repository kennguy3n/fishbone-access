...
func TestMidjourneyFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestMidjourneyFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestMidjourneyFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
