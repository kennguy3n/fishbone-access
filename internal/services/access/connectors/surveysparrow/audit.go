...
// FetchAccessAuditLogs implements access.AccessAuditor for SurveySparrow.
//
// SurveySparrow does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *SurveysparrowAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*SurveysparrowAccessConnector)(nil)
