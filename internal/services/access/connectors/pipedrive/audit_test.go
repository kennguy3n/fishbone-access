...
func pipedriveAuditSecrets() map[string]interface{} {
	return map[string]interface{}{"api_token": "pdtoken"}
}
...
func TestPipedriveFetchAccessAuditLogs_Maps(t *testing.T) {
	...
	err := c.FetchAccessAuditLogs(context.Background(), map[string]interface{}{}, pipedriveAuditSecrets(),
	...
	if len(collected) != 1 || collected[0].ActorExternalID != "42" {
...
func TestPipedriveFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestPipedriveFetchAccessAuditLogs_ServerError(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
