...
func courseraValidConfig() map[string]interface{} { return map[string]interface{}{"org": "acme"} }
func courseraValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "coursera_demo"}
}

func TestCourseraConnectorFlow_FullLifecycle(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		usersPath := "/api/businesses.v1/acme/users"
	...
	cfg := courseraValidConfig()
	secrets := courseraValidSecrets()
...
func TestCourseraConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		courseraValidConfig(), courseraValidSecrets(),
		access.AccessGrant{UserExternalID: "alice@example.com", ResourceExternalID: "learner"})
