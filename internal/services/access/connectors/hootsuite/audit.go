...
// FetchAccessAuditLogs implements access.AccessAuditor for Hootsuite.
//
// Hootsuite does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *HootsuiteAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*HootsuiteAccessConnector)(nil)
