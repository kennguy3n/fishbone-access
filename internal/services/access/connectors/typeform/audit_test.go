...
func TestTypeformFetchAccessAuditLogs_Maps(t *testing.T) {
	...
	if len(collected) != 1 || collected[0].TargetExternalID != "form-99" {
...
func TestTypeformFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestTypeformFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
