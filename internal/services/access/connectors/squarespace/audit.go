...
// FetchAccessAuditLogs implements access.AccessAuditor for Squarespace.
//
// Squarespace does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *SquarespaceAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*SquarespaceAccessConnector)(nil)
