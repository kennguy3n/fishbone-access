...
func TestAppFolioFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestAppFolioFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestAppFolioFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
