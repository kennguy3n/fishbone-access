...
func TestMistralFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestMistralFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestMistralFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
