...
// FetchAccessAuditLogs implements access.AccessAuditor for Zapier.
//
// Zapier does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *ZapierAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*ZapierAccessConnector)(nil)
