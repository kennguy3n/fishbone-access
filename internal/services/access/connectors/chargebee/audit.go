...
// FetchAccessAuditLogs implements access.AccessAuditor for Chargebee.
//
// Chargebee does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *ChargebeeAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*ChargebeeAccessConnector)(nil)
