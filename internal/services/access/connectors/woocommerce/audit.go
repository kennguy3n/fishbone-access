...
// FetchAccessAuditLogs implements access.AccessAuditor for WooCommerce.
//
// WooCommerce does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *WooCommerceAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*WooCommerceAccessConnector)(nil)
