...
func TestNamelyGetSSOMetadata_NilWithoutURL(t *testing.T) {
	c := New()
...
func TestNamelyGetSSOMetadata_WithMetadataURL(t *testing.T) {
	c := New()
	got, err := c.GetSSOMetadata(context.Background(), map[string]interface{}{
		"sso_metadata_url": "https://acme.namely.com/saml/metadata",
		"sso_entity_id":    "https://acme.namely.com/saml",
	}, nil)
	if err != nil {
		t.Fatalf("GetSSOMetadata: %v", err)
	}
