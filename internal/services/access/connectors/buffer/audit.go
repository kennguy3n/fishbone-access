...
// FetchAccessAuditLogs implements access.AccessAuditor for Buffer.
//
// Buffer does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *BufferAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*BufferAccessConnector)(nil)
