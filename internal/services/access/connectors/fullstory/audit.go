...
// FetchAccessAuditLogs implements access.AccessAuditor for FullStory.
//
// FullStory does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *FullstoryAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*FullstoryAccessConnector)(nil)
