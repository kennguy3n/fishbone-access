...
// FetchAccessAuditLogs implements access.AccessAuditor for Heap.
//
// Heap does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *HeapAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*HeapAccessConnector)(nil)
