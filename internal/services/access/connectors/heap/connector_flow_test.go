...
func heapValidConfig() map[string]interface{} { return map[string]interface{}{} }
func heapValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "heap_demo_token"}
}

func TestHeapConnectorFlow_FullLifecycle(t *testing.T) {
...
func TestHeapConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		heapValidConfig(), heapValidSecrets(),
