...
func anthropicValidConfig() map[string]interface{} { return map[string]interface{}{} }
func anthropicValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "sk-ant-admin-AAAA"}
}

func TestAnthropicConnectorFlow_FullLifecycle(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		members := "/v1/organizations/members"
	...
	cfg := anthropicValidConfig()
	secrets := anthropicValidSecrets()
...
func TestAnthropicConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		anthropicValidConfig(), anthropicValidSecrets(),
		access.AccessGrant{UserExternalID: "alice@example.com", ResourceExternalID: "developer"})
