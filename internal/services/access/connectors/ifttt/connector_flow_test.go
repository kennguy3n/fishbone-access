...
func iftttValidConfig() map[string]interface{} { return map[string]interface{}{} }
func iftttValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "ifttt_demo"}
}

func TestIftttConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := iftttValidConfig()
	secrets := iftttValidSecrets()
...
func TestIftttConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		iftttValidConfig(), iftttValidSecrets(),
