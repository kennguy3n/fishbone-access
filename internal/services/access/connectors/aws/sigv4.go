...
//
// This is a hand-rolled implementation tailored to IAM (a global
// "us-east-1" service that uses POST requests with an
// application/x-www-form-urlencoded body — the Action=… parameter
// dictates the API call).
