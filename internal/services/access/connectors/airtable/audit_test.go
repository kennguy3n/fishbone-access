...
func TestFetchAccessAuditLogs_PaginatesAndMaps(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if !strings.HasPrefix(r.URL.Path, "/meta/enterpriseAccount/entABC123/auditLogEvents") {
				...
				"events": []map[string]interface{}{
					{
						...
						"action":    "userInvitedToWorkspace",
						"actingUser": map[string]interface{}{
							"id":    "usr-1",
	...
	if collected[0].EventType != "userInvitedToWorkspace" || collected[0].TargetExternalID != "usr-9" {
