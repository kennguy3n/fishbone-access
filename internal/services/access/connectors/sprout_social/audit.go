...
// FetchAccessAuditLogs implements access.AccessAuditor for Sprout Social.
//
// Sprout Social does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *SproutSocialAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*SproutSocialAccessConnector)(nil)
