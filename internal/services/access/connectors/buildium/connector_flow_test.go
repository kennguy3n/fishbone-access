...
func buildiumValidConfig() map[string]interface{} { return map[string]interface{}{} }
func buildiumValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "buildium_demo"}
}

func TestBuildiumConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := buildiumValidConfig()
	secrets := buildiumValidSecrets()
...
func TestBuildiumConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		buildiumValidConfig(), buildiumValidSecrets(),
