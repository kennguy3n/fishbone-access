...
func nordlayerValidConfig() map[string]interface{} { return map[string]interface{}{} }
func nordlayerValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "nordlayer_demo"}
}

func TestNordLayerConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := nordlayerValidConfig()
	secrets := nordlayerValidSecrets()
...
func TestNordLayerConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		nordlayerValidConfig(), nordlayerValidSecrets(),
