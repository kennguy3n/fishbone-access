...
func TestPerimeter81FetchAccessAuditLogs_Maps(t *testing.T) {
	...
	if len(collected) != 1 || collected[0].TargetExternalID != "net-44" {
...
func TestPerimeter81FetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestPerimeter81FetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
