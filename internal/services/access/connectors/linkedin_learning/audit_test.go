...
func TestLinkedInLearningFetchAccessAuditLogs_Maps(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path != "/v2/auditLogs" {
...
func TestLinkedInLearningFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestLinkedInLearningFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
