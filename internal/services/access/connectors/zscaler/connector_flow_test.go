...
func zscalerValidConfig() map[string]interface{} { return map[string]interface{}{} }
func zscalerValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "zsc-token-AAAA"}
}

func TestZscalerConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := zscalerValidConfig()
	secrets := zscalerValidSecrets()
...
func TestZscalerConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		zscalerValidConfig(), zscalerValidSecrets(),
		access.AccessGrant{UserExternalID: "alice@example.com", ResourceExternalID: "Super Admin"})
