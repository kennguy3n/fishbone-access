...
func TestYardiFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestYardiFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestYardiFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
