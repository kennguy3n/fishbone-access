...
func yardiValidConfig() map[string]interface{} { return map[string]interface{}{} }
func yardiValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "yardi_demo"}
}

func TestYardiConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := yardiValidConfig()
	secrets := yardiValidSecrets()
...
func TestYardiConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		yardiValidConfig(), yardiValidSecrets(),
