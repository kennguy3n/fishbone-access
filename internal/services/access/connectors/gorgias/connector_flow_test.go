...
func TestConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := map[string]interface{}{"account": "acme"}
	secrets := map[string]interface{}{"email": "admin@example.com", "api_key": "k"}
...
func TestConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		map[string]interface{}{"account": "acme"},
		map[string]interface{}{"email": "admin@example.com", "api_key": "k"},
		access.AccessGrant{UserExternalID: "ada@example.com", ResourceExternalID: "agent"})
