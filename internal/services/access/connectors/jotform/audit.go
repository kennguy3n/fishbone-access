...
// FetchAccessAuditLogs implements access.AccessAuditor for Jotform.
//
// Jotform does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *JotformAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*JotformAccessConnector)(nil)
