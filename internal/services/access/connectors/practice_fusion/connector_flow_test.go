...
func practiceFusionValidConfig() map[string]interface{} { return map[string]interface{}{} }
func practiceFusionValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "pf_demo_token"}
}

func TestPracticeFusionConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := practiceFusionValidConfig()
	secrets := practiceFusionValidSecrets()
...
func TestPracticeFusionConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		practiceFusionValidConfig(), practiceFusionValidSecrets(),
		access.AccessGrant{UserExternalID: "alice@example.com", ResourceExternalID: "provider"})
