...
// FetchAccessAuditLogs implements access.AccessAuditor for Wufoo.
//
// Wufoo does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *WufooAccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*WufooAccessConnector)(nil)
