...
func TestPerplexityFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestPerplexityFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestPerplexityFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
