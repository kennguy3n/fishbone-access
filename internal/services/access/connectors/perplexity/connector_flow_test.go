...
func perplexityValidConfig() map[string]interface{} { return map[string]interface{}{} }
func perplexityValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "perplexity_demo"}
}

func TestPerplexityConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := perplexityValidConfig()
	secrets := perplexityValidSecrets()
...
func TestPerplexityConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		perplexityValidConfig(), perplexityValidSecrets(),
