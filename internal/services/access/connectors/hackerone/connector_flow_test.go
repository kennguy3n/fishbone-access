...
func h1ValidConfig() map[string]interface{} {
	return map[string]interface{}{"org_id": "1111"}
}
func h1ValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "h1-token-AAAA"}
}

func TestHackerOneConnectorFlow_FullLifecycle(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		members := "/v1/organizations/1111/members"
		member := members + "/" + user
		mu.Lock()
		defer mu.Unlock()
		switch {
...
func TestHackerOneConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
