...
func validConfig() map[string]interface{} { return map[string]interface{}{"org_id": "999"} }
...
func TestSync_PaginatesUsers(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/v1/organizations/999/members" {
...
func TestValidate_RejectsMissingConfig(t *testing.T) {
	c := New()
	if err := c.Validate(context.Background(), map[string]interface{}{}, validSecrets()); err == nil {
		t.Errorf("expected error for missing %s", "org_id")
	}
}
