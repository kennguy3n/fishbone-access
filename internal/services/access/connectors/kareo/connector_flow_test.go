...
func kareoValidConfig() map[string]interface{} { return map[string]interface{}{} }
func kareoValidSecrets() map[string]interface{} {
	return map[string]interface{}{"token": "kareo_demo"}
}

func TestKareoConnectorFlow_FullLifecycle(t *testing.T) {
	...
	cfg := kareoValidConfig()
	secrets := kareoValidSecrets()
...
func TestKareoConnectorFlow_ProvisionForbiddenFailure(t *testing.T) {
	...
	err := c.ProvisionAccess(context.Background(),
		kareoValidConfig(), kareoValidSecrets(),
		access.AccessGrant{UserExternalID: "alice@example.com", ResourceExternalID: "biller"})
