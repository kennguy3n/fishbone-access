...
func TestZocdocFetchAccessAuditLogs_Maps(t *testing.T) {
...
func TestZocdocFetchAccessAuditLogs_NotAvailable(t *testing.T) {
...
func TestZocdocFetchAccessAuditLogs_TransientFailure(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
