...
// FetchAccessAuditLogs implements access.AccessAuditor for Google Analytics 4.
//
// Google Analytics 4 does not expose a tenant-scoped audit-log REST API. The
...
// for completeness.
func (c *GA4AccessConnector) FetchAccessAuditLogs(
	_ context.Context,
...
var _ access.AccessAuditor = (*GA4AccessConnector)(nil)
